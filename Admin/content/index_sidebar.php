...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class='active'><a href="index.php"><em class="fa fa-laptop icon">&nbsp;</em>Danh Sách Sản Phẩm</a></li>
			<li><a href="comment.php"><em class="fa fa-comment icon">&nbsp;</em>Danh Sách Bình Luận</a></li>
