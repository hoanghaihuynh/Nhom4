			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				...
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo $level.CONT.'update_account.php' ?>" method="get"> 
					...
					<div class="container-login100-form-btn m-t-17">
						...
						<button type='button' class='btn btn-danger' style='height:42px;width:80px;margin-left:5px'><a href="<?php echo $level.'index.php'; ?>" style='text-decoration: none; color:white'>Thoát</a></button>
					</div>
